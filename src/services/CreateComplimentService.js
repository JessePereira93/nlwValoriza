...
var CreateComplimentService = /** @class */ (function () {
    ...
    CreateComplimentService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var complimentsRepositories, userRepositories, userReceiverExists, compliment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userRepositories.findOne(user_receiver)];
                    case 1:
                        userReceiverExists = _b.sent();
                        if (!userReceiverExists)
                            throw new Error("User Receiver does nor exists!");
